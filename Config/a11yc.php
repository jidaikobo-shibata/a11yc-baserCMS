...
// guest access approved IPs - must be array
...
define('A11YC_USERS', serialize(array(
	1 => array(
		'root',
		'$2y$10$jg5lO2bP8Ba5/j2GkXTYSeYIYOEFOgIcMPiSP6/VFITvlk1H9KtSi', // 'adminpass'
		'ROOT',
		''
	),
)));
...
// pathes
define('A11YC_LIB_PATH',      dirname(__DIR__).'/a11yc/libs');
...
define('A11YC_DOC_URL',             A11YC_URL.'/admin/a11yc/A11ycDocs/each?criterion=');
